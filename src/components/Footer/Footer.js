...
const Footer = () => {
    return (
        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
                <Link rel="noopener noreferrer" to='/' className="flex justify-center space-x-3 lg:justify-start">
                    <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-white dark:text-violet-400">
                    ...
                    <span className="self-center text-2xl font-semibold">GLOBAL ONLINE COURSES</span>
                </Link>
            </div>
            <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 text-left">
                <div className="space-y-3">
                    <h3 className="tracking-wide uppercase dark:text-gray-50">Global Online</h3>
                ...
                <div className="space-y-3 text-left">
                    <h3 className="tracking-wide uppercase dark:text-gray-50">Online courses </h3>
                    <ul className="space-y-1">
                        <li>
                ...
                <div className="space-y-3">
                    <h3 className="uppercase dark:text-gray-50 text-left">Developers</h3>
                ...
                <div className="space-y-3 text-left">
                    ...
                    <div className="flex justify-start space-x-3">
                        <Link rel="noopener noreferrer" to='/login' title="Facebook" className="flex items-center p-1">
        ...
        <div className="py-6 text-sm text-center dark:text-gray-400">© 2022 GLOBAL ONLINE COURSES. All rights reserved.</div>
    </footer>
    );
};
